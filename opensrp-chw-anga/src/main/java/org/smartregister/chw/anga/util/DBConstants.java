...
public class DBConstants {
    ...
    public final class KEY {
        ...
        public static final String DATE_CHW_ANGA_TEST = "date_chw_anga_test";
        public static final String FEVER_ANGA_CHW = "fever_anga_chw";
        public static final String FEVER_DURATION = "fever_duration";
        public static final String ANGA_RESULTS = "anga_results";
        public static final String DATE_HF_ANGA_TEST = "date_hf_anga_test";
        public static final String ANGA_TEST_DATE = "anga_test_date";
        public static final String ANGA_TREAT = "anga_treat";
        ...
        public static final String ANGA_EDU_CHW = "anga_edu_chw";
        ...
        public static final String PHONE_NUMBER_ANGA = "phoneNumberAnga";
        public static final String GEST_AGE = "gest_age";
        public static final String DELIVERY_DATE = "delivery_date";
        public static final String ANGA_FOLLOW_UP_DATE = "date_chw_mfollowup";
