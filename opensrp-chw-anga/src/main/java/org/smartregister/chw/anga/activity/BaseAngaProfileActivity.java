package org.smartregister.chw.anga.activity;
...
import org.smartregister.chw.anga.custom_views.BaseAngaFloatingMenu;
import org.smartregister.chw.anga.dao.AngaDao;
import org.smartregister.chw.anga.domain.MemberObject;
import org.smartregister.chw.anga.interactor.BaseAngaProfileInteractor;
...
public class BaseAngaProfileActivity extends BaseProfileActivity implements AngaProfileContract.View, AngaProfileContract.InteractorCallBack {
    protected MemberObject memberObject;
    protected AngaProfileContract.Presenter profilePresenter;
    protected CircleImageView imageView;
    protected TextView textViewName;
    protected TextView textViewGender;
    protected TextView textViewLocation;
    protected TextView textViewUniqueID;
    protected TextView textViewRecordAnga;
    ...
    protected RelativeLayout rlAngaPositiveDate;
    ...
    protected BaseAngaFloatingMenu baseAngaFloatingMenu;

    public static void startProfileActivity(Activity activity, String baseEntityId) {
        Intent intent = new Intent(activity, BaseAngaProfileActivity.class);
    ...
    protected void onCreation() {
        setContentView(R.layout.activity_anga_profile);
        ...
        toolbar.setNavigationOnClickListener(v -> BaseAngaProfileActivity.this.finish());
        ...
        rlAngaPositiveDate = findViewById(R.id.rlAngaPositiveDate);
        ...
        textViewRecordAnga = findViewById(R.id.textview_record_anga);
        ...
        rlAngaPositiveDate.setOnClickListener(this);
        textViewRecordAnga.setOnClickListener(this);
        textViewRecordAnc.setOnClickListener(this);
        textViewUndo.setOnClickListener(this);

        imageRenderHelper = new ImageRenderHelper(this);
        memberObject = AngaDao.getMember(baseEntityId);
        initializePresenter();
    ...
    protected void initializePresenter() {
        ...
        profilePresenter = new BaseAngaProfilePresenter(this, new BaseAngaProfileInteractor(), memberObject);
        fetchProfileData();
    ...
    public void initializeFloatingMenu() {
        if (StringUtils.isNotBlank(memberObject.getPhoneNumber())) {
            baseAngaFloatingMenu = new BaseAngaFloatingMenu(this, memberObject);
            baseAngaFloatingMenu.setGravity(Gravity.BOTTOM | Gravity.RIGHT);
            LinearLayout.LayoutParams linearLayoutParams = new LinearLayout.LayoutParams(
                    LinearLayout.LayoutParams.MATCH_PARENT,
                    LinearLayout.LayoutParams.MATCH_PARENT);
            addContentView(baseAngaFloatingMenu, linearLayoutParams);
        }
    }

    @Override
    public void hideView() {
        textViewRecordAnga.setVisibility(View.GONE);
    }
    ...
    public void setProfileViewWithData() {
        ...
        textViewGender.setText(AngaUtil.getGenderTranslated(this, memberObject.getGender()));
        ...
        if (StringUtils.isNotBlank(memberObject.getFamilyHead()) && memberObject.getFamilyHead().equals(memberObject.getBaseEntityId())) {
            findViewById(R.id.family_anga_head).setVisibility(View.VISIBLE);
        }
        if (StringUtils.isNotBlank(memberObject.getPrimaryCareGiver()) && memberObject.getPrimaryCareGiver().equals(memberObject.getBaseEntityId())) {
            findViewById(R.id.primary_anga_caregiver).setVisibility(View.VISIBLE);
        }
        if (memberObject.getAngaTestDate() != null) {
            textview_positive_date.setText(getString(R.string.anga_positive) + " " + formatTime(memberObject.getAngaTestDate()));
        }
    }

    @Override
    public void setOverDueColor() {
        textViewRecordAnga.setBackground(getResources().getDrawable(R.drawable.record_btn_selector_overdue));
    }
    ...
    public void refreshUpComingServicesStatus(String service, AlertStatus status, Date date) {
        ...
        if (status == AlertStatus.upcoming) {
            tvUpComingServices.setText(AngaUtil.fromHtml(getString(R.string.vaccine_service_upcoming, service, dateFormat.format(date))));
        } else {
            tvUpComingServices.setText(AngaUtil.fromHtml(getString(R.string.vaccine_service_due, service, dateFormat.format(date))));
        }
    }
    ...
    public void refreshFamilyStatus(AlertStatus status) {
        ...
        if (status == AlertStatus.complete) {
            ...
            tvFamilyStatus.setText(AngaUtil.fromHtml(getString(R.string.family_has_service_overdue)));
        }
    }
