package org.smartregister.chw.anga;
...
public class AngaLibrary {
    private static AngaLibrary instance;
    ...
    public static void init(Context context, Repository repository, int applicationVersion, int databaseVersion) {
        if (instance == null) {
            instance = new AngaLibrary(context, repository, applicationVersion, databaseVersion);
        }
    }

    public static AngaLibrary getInstance() {
        if (instance == null) {
    ...
    private AngaLibrary(Context contextArg, Repository repositoryArg, int applicationVersion, int databaseVersion) {
